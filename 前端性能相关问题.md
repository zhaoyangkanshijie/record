...
1. 参考链接：
  ...
  [Vite和Webpack的核心差异](https://blog.csdn.net/petertanjinjie/article/details/114109512)
...
2. 详解：
  ...
  * vite与webpack对比
    ...
    * vite打包原理
      ...
      1. 声明一个入口 script 标签类型为 module (main.js)，通过get请求获取内容
      2. 扫描文件内容，遇到import，则get请求获取内容，递归进行
      3. 简单合并和整合文件，不打包编译
    ...
    * vite缺点
      ...
      1. 生态不如webpack
      2. prod环境的构建，目前用的Rollup，esbuild对于css和代码分割不是很友好
      3. 要求较高版本的浏览器兼容ES Module
