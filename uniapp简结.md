...
1. 参考链接
    ...
    [uniapp如何在真机、手机模拟器、微信开发者工具中运行调试](https://blog.csdn.net/qq_39009348/article/details/107912503)

2. 详解

    1. 下载安装网易MUMU手机模拟器，设置375*667
    2. 运行->运行到手机->安卓模拟器端口设置->运行配置

        adb路径：HbuilderX安装路径/plugins/launcher/tools/adbs/adb.exe
