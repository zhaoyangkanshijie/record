...
2. 详解：
    ...
    * https请求过程(TLS):
        ...
        * 为什么需要 CA 认证机构颁发证书？
            ...
            * 中间人攻击：中间人分别和客户、正规网站通过https连接，因取得对称秘钥，可轻易窃取信息
    ...
    * 指标
        ...
        3. FMP(First Meaningful Paint)首次有意义的绘制
            ...
            * 首屏时间
                ...
                w3c标准(SPA兴起后失效(peformance与截屏计时工具不一致)，现坐等w3c标准化)
                ```js
                var perfData = window.performance.timing; 
                var renderTime = perfData.domComplete - perfData.domLoading;
                ```
        ...
        7. FPS(Frames Per Second)每秒帧率
            ...
            每秒钟画面更新次数，当今大多数设备的屏幕刷新率都是60次/秒
        ...
        9. 上报策略
            ...
            * pv/uv:监听各种页面切换的情况；SPA页面，可以监听hashChange
            * 性能数据/设备信息/网络状况
